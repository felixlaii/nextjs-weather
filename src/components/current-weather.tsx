...
const weather =
  "w-1/3 border-6 rounded-lg shadow-xl text-white bg-gray-600 mx-auto mt-20 mb-0 p-0 sm:p-4";
...
const parameterLabelTop =
  "border-b border-white text-left font-400 text-[12px]";
    ...
    <div className={weather}>
      ...
      <div className={top}>
        ...
        <div className="w-full pl-20">
          ...
          <div className={parameterRow}>
            <span className="text-left text-4">Feels like</span>
            <span className="text-right text-4">
